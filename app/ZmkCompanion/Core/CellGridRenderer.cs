...
static class CellGridRenderer
{
    ...
    public static byte[] RenderCell(CellTier tier, string element)
    {
        ...
        // Font sized to the cell: cell heights were chosen ~1.7× width to
        // match FiraCode's natural proportions, so height drives the size.
        using var font = NerdFont.CreateFont(tier.H * 0.78f);
        var sf = StringFormat.GenericTypographic;
        SizeF sz = g.MeasureString(element, font, PointF.Empty, sf);
