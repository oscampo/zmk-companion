...
internal static class CliRunner
{
    ...
    {
        var pipe = new NamedPipeClientStream(".", PipeServer.PipeName,
    ...
    {
        Console.Error.WriteLine("zkc: tray app not running — launch zkc.exe from the Start menu first.");
        return 1;
    }
    ...
    private static void PrintHelp() => Console.WriteLine("""
        ...
        Notes:
          ...
          The zkc tray app must be running.
        """);
}
